...
import { F as isRedirect, b as useRouter, d as useRouterState, v as Link, y as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { r as Slot, s as require_jsx_runtime } from "../_libs/@radix-ui/react-collection+[...].mjs";
import { a as getServerFnById, r as createServerFn, t as TSS_SERVER_FUNCTION } from "./server-Brx4YFZf.mjs";
...
import { i as cn, r as Input, t as Button } from "./card-CO3AMkHH.mjs";
import { n as objectType, r as stringType, t as booleanType } from "../_libs/zod.mjs";
import { n as useQuery } from "../_libs/tanstack__react-query.mjs";
import { C as LogOut, S as PanelLeft, T as LayoutDashboard, b as Radar, d as ShieldCheck, g as ScanSearch, t as X, w as LoaderCircle } from "../_libs/lucide-react.mjs";
import { t as Root } from "../_libs/radix-ui__react-separator.mjs";
import { a as Trigger, i as Root3, n as Portal, r as Provider, t as Content2 } from "../_libs/radix-ui__react-tooltip.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/use-scan-queries-BnRAowCm.js
...
var runScan = createServerFn({ method: "POST" }).middleware([attachSupabaseAuth, requireSupabaseAuth]).inputValidator((input) => ScanInput.parse(input)).handler(createSsrRpc("fa8336d1481611070fd84160b87a6d6d362b4d6bd6b5c4f6b107f76e6f70d307"));
var listScans = createServerFn({ method: "GET" }).middleware([attachSupabaseAuth, requireSupabaseAuth]).handler(createSsrRpc("87d6a9d08d157be7d0ec31ab686026892635e4529c13628a7532fd49f0d890b8"));
var getScanReport = createServerFn({ method: "GET" }).middleware([attachSupabaseAuth, requireSupabaseAuth]).inputValidator((input) => objectType({ id: stringType().uuid() }).parse(input)).handler(createSsrRpc("3db688898c70a5b9bc49ef4791151a2c641e2cde6cfc96136c34b4b45b8963b6"));
var getScanSarif = createServerFn({ method: "GET" }).middleware([attachSupabaseAuth, requireSupabaseAuth]).inputValidator((input) => objectType({ id: stringType().uuid() }).parse(input)).handler(createSsrRpc("c2cd8fcf498a6c25bdda8b4a6632ec32894feb71792cf77ba76af61f8970a5ac"));
var listPolicies = createServerFn({ method: "GET" }).middleware([attachSupabaseAuth, requireSupabaseAuth]).handler(createSsrRpc("ca37418eaa19ceb3a3dd5eccd4788151293eccb99562353953f11c3c29941a99"));
var CopilotInput = objectType({
	instruction: stringType().min(1).max(2e3),
	source_code: stringType().min(1).max(6e4),
	file_type: stringType().min(1).max(40)
});
var copilotRemediate = createServerFn({ method: "POST" }).middleware([attachSupabaseAuth, requireSupabaseAuth]).inputValidator((input) => CopilotInput.parse(input)).handler(createSsrRpc("bf094d02b29073046a699be718d9a643ec0d8c6ebf768626fcc60b5a49d4ce81"));
var togglePolicy = createServerFn({ method: "POST" }).middleware([attachSupabaseAuth, requireSupabaseAuth]).inputValidator((input) => objectType({
	id: stringType().uuid(),
	enabled: booleanType()
}).parse(input)).handler(createSsrRpc("876934eeaf00eb51604a2ee5805376bf02549a6d545f0d2b04411f505a045905"));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex h-8 w-8 items-center justify-center rounded-md bg-primary text-primary-foreground glow-primary",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Radar, { className: "h-4 w-4" })
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex flex-col leading-none group-data-[collapsible=icon]:hidden",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarFooter, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "rounded-md border border-border/60 bg-card/50 p-2 text-[11px] text-muted-foreground group-data-[collapsible=icon]:hidden",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-1.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-1.5 w-1.5 rounded-full bg-primary animate-pulse" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Engine online · Enterprise tier" })]
				})
			}) })
		]
	});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border/60 bg-background/80 px-4 backdrop-blur",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-1 items-baseline gap-3 min-w-0",
...
*/
function useScansQuery(initialScans = []) {
...
function useScanReportQuery(scanId) {
...
function usePoliciesQuery(initialPolicies = []) {
	...
	const { data: policies = [], isLoading } = useQuery({
		...
		queryFn: async () => {
			try {
				...
				console.warn("Failed to fetch remote policy list, returning empty array:", err);
				return [];
			}
		},
...
//#endregion
export { getScanSarif as a, usePoliciesQuery as c, useServerFn as d, getScanReport as i, useScanReportQuery as l, RequireAuth as n, runScan as o, copilotRemediate as r, togglePolicy as s, AppShell as t, useScansQuery as u };
