...
import { D as KeyRound, M as FileCheckCorner, W as Boxes, d as ShieldCheck, f as ShieldAlert, h as Search, l as Sparkles, n as Wrench, p as Settings2 } from "../_libs/lucide-react.mjs";
import { c as usePoliciesQuery, d as useServerFn, n as RequireAuth, s as togglePolicy, t as AppShell } from "./use-scan-queries-BnRAowCm.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { n as Route$4 } from "./router-CEZ7_A7D2.mjs";
import { n as SwitchThumb, t as Switch$1 } from "../_libs/radix-ui__react-switch.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/policies-BPI4Sdtc.js
...
function PolicyPresetSidebar({ policies, activePreset, applyingPreset, onApply }) {
...
function PolicyFrameworkList({ policies, filtered, query, isLoading, applyingPreset, onQueryChange, onToggle, onApplyPreset }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-6",
		children: [
...
function Policies() {
	...
	const { policies, isLoading } = usePoliciesQuery(Route$4.useLoaderData().policies);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RequireAuth, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppShell, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PolicyPresetSidebar, {
					policies,
					activePreset,
					applyingPreset,
					onApply: applyPreset
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PolicyFrameworkList, {
					policies,
					filtered,
					query,
					isLoading,
