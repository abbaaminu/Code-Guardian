...
//#region node_modules/.nitro/vite/services/ssr/assets/server-Brx4YFZf.js
var server_Brx4YFZf_exports = /* @__PURE__ */ __exportAll({
	a: () => getServerFnById,
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-1mrXNo3P.mjs");
...
var manifest = {
	"3db688898c70a5b9bc49ef4791151a2c641e2cde6cfc96136c34b4b45b8963b6": {
		...
		importer: () => import("./scan.functions-DLvpL1lK.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CEZ7_A7D.mjs").then((n) => n.t),
		import("./start-vVgE4y0H.mjs"),
...
//#endregion
export { getServerFnById as a, getRequest as i, createMiddleware as n, server_Brx4YFZf_exports as o, createServerFn as r, TSS_SERVER_FUNCTION as t };
