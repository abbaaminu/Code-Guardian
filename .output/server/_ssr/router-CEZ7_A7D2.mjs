...
import { R as redirect, _ as createRootRouteWithContext, g as createFileRoute, h as lazyRouteComponent, l as Scripts, m as Outlet, p as createRouter, u as HeadContent } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { i as RoutePendingFallback, n as RouteErrorFallback, r as RouteNotFoundFallback } from "./router-CEZ7_A7D.mjs";
import processModule from "node:process";
import { Buffer } from "node:buffer";
import { createHmac, timingSafeEqual } from "node:crypto";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CEZ7_A7D.js
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CNSfpNk9.css";
var Toaster$1 = ({ ...props }) => {
...
var $$splitErrorComponentImporter$4 = () => import("./routes-BFQ0DWJi.mjs");
...
var $$splitErrorComponentImporter$3 = () => import("./dashboard-DhIpCdo3.mjs");
var $$splitComponentImporter$3 = () => import("./dashboard-CsG6XtTY.mjs");
...
var $$splitErrorComponentImporter$2 = () => import("./login-DVcbgcYg.mjs");
...
var $$splitErrorComponentImporter$1 = () => import("./policies-D3AzRCZE.mjs");
var $$splitComponentImporter$1 = () => import("./policies-BPI4Sdtc.mjs");
var Route$4 = createFileRoute("/policies")({
...
var $$splitNotFoundComponentImporter = () => import("./scans._id-C3NLtup_.mjs");
var $$splitErrorComponentImporter = () => import("./scans._id-DEB14Afs.mjs");
var $$splitComponentImporter = () => import("./scans._id-CsylsHzq.mjs");
var Route$2 = createFileRoute("/scans/$id")({
	...
	parseParams: ({ id }) => {
		if (!stringType().uuid().safeParse(id).success) return false;
		return { id };
	},
...
async function requireBearerUser(request) {
	...
	const { verifySupabaseToken } = await import("./auth-middleware-ABo1HzMN.mjs").then((n) => n.t).then((n) => n.t);
	try {
...
var Route$1 = createFileRoute("/api/scan/instant")({ server: { handlers: { POST: async ({ request }) => {
	try {
...
var Route = createFileRoute("/api/webhooks/github")({ server: { handlers: { POST: async ({ request }) => {
...
var rootRouteChildren = {
	...
	ScansIdRoute: Route$2.update({
		id: "/scans/$id",
		path: "/scans/$id",
		getParentRoute: () => Route$8
	}),
	ApiScanInstantRoute: Route$1.update({
		id: "/api/scan/instant",
		path: "/api/scan/instant",
		getParentRoute: () => Route$8
	}),
	ApiWebhooksGithubRoute: Route.update({
...
//#endregion
export { router_exports as a, getRouter as i, Route$4 as n, Route$6 as r, Route$2 as t };
